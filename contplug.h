...
int __stdcall ContentGetValueW(const WCHAR* FileName, int FieldIndex, int UnitIndex, void* FieldValue, int maxSize, int flags);
...
void __stdcall ContentStopGetValueW(const WCHAR* FileName);
...
int __stdcall ContentSetValueW(const WCHAR* FileName, int FieldIndex, int UnitIndex, int FieldType, void* FieldValue, int flags);
int __stdcall ContentEditValue(HWND ParentWin, int FieldIndex, int UnitIndex, int FieldType, void* FieldValue, int maxSize, int flags, const char* langidentifier);
void __stdcall ContentSendStateInformation(int state, const char* path);
void __stdcall ContentSendStateInformationW(int state, const WCHAR* path);
...
int __stdcall ContentCompareFilesW(PROGRESSCALLBACKPROC progresscallback, int CompareIndex, const WCHAR* FileName1, const WCHAR* FileName2, FileDetailsStruct* filedetails);
